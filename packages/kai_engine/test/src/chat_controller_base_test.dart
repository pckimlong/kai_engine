...
// class MockKaiInspector extends Mock implements KaiInspector {}
...
//       // Setup inspector mocks
//       when(() => mockInspector.startSession(any())).thenAnswer((_) async {});
//       when(() => mockInspector.startTimeline(any(), any(), any())).thenAnswer((_) async {});
//       when(() => mockInspector.endTimeline(any(), any())).thenAnswer((_) async {});
//       when(
//         () => mockInspector.endTimeline(any(), any(), status: any(named: 'status')),
//       ).thenAnswer((_) async {});
