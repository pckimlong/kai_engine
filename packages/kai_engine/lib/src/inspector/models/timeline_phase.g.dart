...
_TimelinePhase _$TimelinePhaseFromJson(
  ...
  logs:
      ...
      const [],
  promptMessagesLogs:
      (json['promptMessagesLogs'] as List<dynamic>?)
          ?.map((e) => PromptMessagesLog.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
  generatedMessagesLogs:
      (json['generatedMessagesLogs'] as List<dynamic>?)
          ?.map((e) => GeneratedMessagesLog.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
);
...
Map<String, dynamic> _$TimelinePhaseToJson(_TimelinePhase instance) =>
    <String, dynamic>{
      ...
      'logs': instance.logs,
      'promptMessagesLogs': instance.promptMessagesLogs,
      'generatedMessagesLogs': instance.generatedMessagesLogs,
    };
